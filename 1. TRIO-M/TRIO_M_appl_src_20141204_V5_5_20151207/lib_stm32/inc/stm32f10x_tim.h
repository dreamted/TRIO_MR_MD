...
void TIM_Cmd(TIM_TypeDef* TIMx, u32 NewState);
void TIM_ITConfig(TIM_TypeDef* TIMx, u16 TIM_IT, u32 NewState);
void TIM_DMAConfig(TIM_TypeDef* TIMx, u16 TIM_DMABase, u16 TIM_DMABurstLength);
void TIM_DMACmd(TIM_TypeDef* TIMx, u16 TIM_DMASource, u32 Newstate);
...
void TIM_ARRPreloadConfig(TIM_TypeDef* TIMx, u32 Newstate);
void TIM_SelectCCDMA(TIM_TypeDef* TIMx, u32 Newstate);
...
void TIM_UpdateDisableConfig(TIM_TypeDef* TIMx, u32 Newstate);
...
void TIM_SelectHallSensor(TIM_TypeDef* TIMx, u32 Newstate);
