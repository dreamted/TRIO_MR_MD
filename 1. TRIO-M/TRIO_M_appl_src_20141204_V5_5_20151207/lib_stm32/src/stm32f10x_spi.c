...
// Private define
// SPI SPE mask
#define SPI_CR1_SPE_Set			((u16)0x0040)
#define SPI_CR1_SPE_Rst			((u16)0xFFBF)

// I2S I2SE mask
#define I2SCFGR_I2SE_Set		((u16)0x0400)
#define I2SCFGR_I2SE_Rst		((u16)0xFBFF)

// SPI CRCNext mask
#define SPI_CR1_CRCNext_Set		((u16)0x1000)

// SPI CRCEN mask
#define SPI_CR1_CRCEN_Set		((u16)0x2000)
#define SPI_CR1_CRCEN_Rst		((u16)0xDFFF)

// SPI SSOE mask
#define SPI_CR2_SSOE_Set        ((u16)0x0004)
#define SPI_CR2_SSOE_Rst		((u16)0xFFFB)

// SPI registers Masks
#define SPI_CR1_CLEAR_Mask		((u16)0x3040)
...
void SPI1Init(void)
{
	SPI_InitTypeDef ival;
		
	RCC->APB2ENR.Data |= (__SPI1EN);

	ival.SPI_Direction = SPI_Direction_2Lines_FullDuplex;
	ival.SPI_Mode = SPI_Mode_Master;
	ival.SPI_DataSize = SPI_DataSize_8b;
	ival.SPI_CPOL = SPI_CPOL_Low;
	ival.SPI_CPHA = SPI_CPHA_1Edge;
	ival.SPI_NSS = SPI_NSS_Soft;
	ival.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_8;
	ival.SPI_FirstBit = SPI_FirstBit_MSB;
	ival.SPI_CRCPolynomial = 7;
...
void SPI_Init(SPI_TypeDef* SPIx, SPI_InitTypeDef* SPI_InitStruct)
{
	...
	// Write to SPIx CR1
	SPIx->CR1.Data = tmpreg;

	// Activate the SPI mode (Reset I2SMOD bit in I2SCFGR register)
	SPIx->I2SCFGR.Data &= SPI_Mode_Select;		
...
void I2S_Init(SPI_TypeDef* SPIx, I2S_InitTypeDef* I2S_InitStruct)
{
	...
	SPIx->I2SCFGR.Data &= I2SCFGR_CLEAR_Mask; 
	SPIx->I2SPR.Data = 0x0002;

	/* Get the I2SCFGR register value */
	tmpreg = SPIx->I2SCFGR.Data;
	...
	SPIx->I2SPR.Data = (u16)(i2sdiv | i2sodd | I2S_InitStruct->I2S_MCLKOutput);  
...
* Return         : None
*******************************************************************************/
void SPI_Cmd(SPI_TypeDef* SPIx, u32 NewState)
{
	// Check the parameters
	if (NewState)	SPIx->CR1.Data |= SPI_CR1_SPE_Set;
	else			SPIx->CR1.Data &= SPI_CR1_SPE_Rst;
}
...
* Return         : None
*******************************************************************************/
void I2S_Cmd(SPI_TypeDef* SPIx, u32 NewState)
{
  /* Check the parameters */
  ...
  if (NewState != DISABLE)
  {
    ...
    SPIx->I2SCFGR.Data |= I2SCFGR_I2SE_Set;
  }
  else
  {
    /* Disable the selected SPI peripheral (in I2S mode) */
    SPIx->I2SCFGR.Data &= I2SCFGR_I2SE_Rst;
  }
}
...
* Return         : None
*******************************************************************************/
void SPI_I2S_ITConfig(SPI_TypeDef* SPIx, u8 SPI_I2S_IT, u32 NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    SPIx->CR2.Data |= itmask;
  }
  else
  {
    /* Disable the selected SPI/I2S interrupt */
    SPIx->CR2.Data &= (u16)~itmask;
  }
}
...
* Return         : None
*******************************************************************************/
void SPI_I2S_DMACmd(SPI_TypeDef* SPIx, u16 SPI_I2S_DMAReq, u32 NewState)
{
  /* Check the parameters */
 // assert_param(IS_SPI_ALL_PERIPH(SPIx));
 // assert_param(IS_FUNCTIONAL_STATE(NewState));
 // assert_param(IS_SPI_I2S_DMAREQ(SPI_I2S_DMAReq));
  ...
  if (NewState != DISABLE)
  {
    ...
    SPIx->CR2.Data |= SPI_I2S_DMAReq;
  }
  else
  {
    /* Disable the selected SPI/I2S DMA requests */
    SPIx->CR2.Data &= (u16)~SPI_I2S_DMAReq;
  }
}
...
void SPI_NSSInternalSoftwareConfig(SPI_TypeDef* SPIx, u16 SPI_NSSInternalSoft)
{
  ...
  if (SPI_NSSInternalSoft != SPI_NSSInternalSoft_Reset)
  {
    ...
    SPIx->CR1.Data |= SPI_NSSInternalSoft_Set;
  }
  else
  {
    /* Reset NSS pin internally by software */
    SPIx->CR1.Data &= SPI_NSSInternalSoft_Reset;
  }
}
...
* Return         : None
*******************************************************************************/
void SPI_SSOutputCmd(SPI_TypeDef* SPIx, u32 NewState)
{
  /* Check the parameters */
  //assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  if (NewState != DISABLE)
  {
    ...
    SPIx->CR2.Data |= SPI_CR2_SSOE_Set;
  }
  else
  {
    /* Disable the selected SPI SS output */
    SPIx->CR2.Data &= SPI_CR2_SSOE_Rst;
  }
}
...
void SPI_DataSizeConfig(SPI_TypeDef* SPIx, u16 SPI_DataSize)
{
  ...
  /* Clear DFF bit */
  SPIx->CR1.Data &= (u16)~SPI_DataSize_16b;
  /* Set new DFF bit value */
  SPIx->CR1.Data |= SPI_DataSize;
}
...
void SPI_TransmitCRC(SPI_TypeDef* SPIx)
{
	/* Enable the selected SPI CRC transmission */
  	SPIx->CR1.Data |= SPI_CR1_CRCNext_Set;
}
...
* Return         : None
*******************************************************************************/
void SPI_CalculateCRC(SPI_TypeDef* SPIx, u32 NewState)
{
  /* Check the parameters */
  //assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  if (NewState != DISABLE)
  {
    ...
    SPIx->CR1.Data |= SPI_CR1_CRCEN_Set;
  }
  else
  {
    /* Disable the selected SPI CRC calculation */
    SPIx->CR1.Data &= SPI_CR1_CRCEN_Rst;
  }
}
...
void SPI_BiDirectionalLineConfig(SPI_TypeDef* SPIx, u16 SPI_Direction)
{
  ...
  if (SPI_Direction == SPI_Direction_Tx)
  {
    ...
    SPIx->CR1.Data |= SPI_Direction_Tx;
  }
  else
  {
    /* Set the Rx only mode */
    SPIx->CR1.Data &= SPI_Direction_Rx;
  }
}
...
FlagStatus SPI_I2S_GetFlagStatus(SPI_TypeDef* SPIx, u16 SPI_I2S_FLAG)
{
  ...
  if ((SPIx->SR.Data & SPI_I2S_FLAG) != (u16)RESET)
  {
    /* SPI_I2S_FLAG is set */
    bitstatus = SET;
  }
...
ITStatus SPI_I2S_GetITStatus(SPI_TypeDef* SPIx, u8 SPI_I2S_IT)
{
  ...
  enablestatus = (SPIx->CR2.Data & itmask) ;

  /* Check the status of the specified SPI/I2S interrupt */
  if (((SPIx->SR.Data & itpos) != (u16)RESET) && enablestatus)
  {
    /* SPI_I2S_IT is set */
    bitstatus = SET;
  }
