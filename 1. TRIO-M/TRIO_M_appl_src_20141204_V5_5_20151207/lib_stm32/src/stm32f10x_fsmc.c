...
* Return         : None
*******************************************************************************/
void FSMC_NORSRAMCmd(u32 FSMC_Bank, u32 NewState)
{
    //assert_param(IS_FSMC_NORSRAM_BANK(FSMC_Bank));
...
* Return         : None
*******************************************************************************/
void FSMC_NANDCmd(u32 FSMC_Bank, u32 NewState)
{
    //assert_param(IS_FSMC_NAND_BANK(FSMC_Bank));
    //assert_param(IS_FUNCTIONAL_STATE(NewState));
...
* Return         : None
*******************************************************************************/
void FSMC_PCCARDCmd(u32 NewState)
{
  //assert_param(IS_FUNCTIONAL_STATE(NewState));
...
* Return         : None
*******************************************************************************/
void FSMC_NANDECCCmd(u32 FSMC_Bank, u32 NewState)
{
  //assert_param(IS_FSMC_NAND_BANK(FSMC_Bank));
  //assert_param(IS_FUNCTIONAL_STATE(NewState));
...
* Return         : None
*******************************************************************************/
void FSMC_ITConfig(u32 FSMC_Bank, u32 FSMC_IT, u32 NewState)
{
...
// __interwork: Declares a function to be callable from both ARM and
//              Thumb mode
...
////////////////////////////////////////////////////////////////////////////////
// Summary of extended keywords
// - location: Specifies the absolute address of a variable, or places groups
//             of functions or variables in named sections
//			   #pragma location={address|NAME}

//	 Example :#pragma location=0xFFFF0400
//
//            __no_init volatile char PORT1;
//            //PORT1 is located at address 0xFFFF0400
//            #pragma location="foo"
