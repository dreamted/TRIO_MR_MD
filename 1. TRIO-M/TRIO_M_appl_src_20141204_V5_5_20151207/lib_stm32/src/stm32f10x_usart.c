...
#define _USART_CR1_CLEAR_Mask	  ((u16)0xE9F3)  /* USART CR1 Mask */
#define _USART_CR2_CLEAR_Mask     ((u16)0xC0FF)  /* USART CR2 Mask */
...
/*---------------------------- USART CR2 Configuration -----------------------*/
  ...
  /* Write to USART CR2 */
  USARTx->CR2.Data = (u16)tmpreg;

/*---------------------------- USART CR1 Configuration -----------------------*/
  tmpreg = 0x00;
  tmpreg = USARTx->CR1.Data;
  ...
  /* Write to USART CR1 */
  USARTx->CR1.Data = (u16)tmpreg;

/*---------------------------- USART CR3 Configuration -----------------------*/
  tmpreg = 0x00;
  tmpreg = USARTx->CR3.Data;
...
void USART_DMACmd(USART_TypeDef* USARTx, u16 USART_DMAReq, INT32U NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    USARTx->CR3.Data |= USART_DMAReq;
  }
  else
  {
    /* Disable the DMA transfer for selected requests by clearing the DMAT and/or
    DMAR bits in the USART CR3 register */
    USARTx->CR3.Data &= (u16)~USART_DMAReq;
  }
}
...
void USART_SetAddress(USART_TypeDef* USARTx, u8 USART_Address)
{
  ...
  USARTx->CR2.Data &= CR2_Address_Mask;
  /* Set the USART address node */
  USARTx->CR2.Data |= USART_Address;
}
...
void USART_WakeUpConfig(USART_TypeDef* USARTx, u16 USART_WakeUp)
{
  ...
  USARTx->CR1.Data &= CR3_WAKE_Mask;
  USARTx->CR1.Data |= USART_WakeUp;
}
...
void USART_LINBreakDetectLengthConfig(USART_TypeDef* USARTx, u16 USART_LINBreakDetectLength)
{
  ...
  USARTx->CR2.Data &= CR3_LBDL_Mask;
  USARTx->CR2.Data |= USART_LINBreakDetectLength;  
}
...
void USART_SendData(USART_TypeDef* USARTx, u16 Data)
{
  ...
  /* Transmit Data */
  USARTx->DR.Data = (Data & (u16)0x01FF);
}
...
{
  /* Receive Data */
  return (u16)(USARTx->DR.Data & (u16)0x01FF);
}
...
{    
  ...
  USARTx->GTPR.Data &= GTPR_LSB_Mask;
  /* Set the USART guard time */
  USARTx->GTPR.Data |= (u16)((u16)USART_GuardTime << 0x08);
}
...
{ 
  ...
  USARTx->GTPR.Data &= GTPR_MSB_Mask;
  /* Set the USART prescaler */
  USARTx->GTPR.Data |= USART_Prescaler;
}
...
void USART_SmartCardCmd(USART_TypeDef* USARTx, INT32U NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    USARTx->CR3.Data |= CR3_SCEN_Set;
  }
  else
  {
    /* Disable the SC mode by clearing the SCEN bit in the CR3 register */
    USARTx->CR3.Data &= CR3_SCEN_Reset;
  }
}
...
void USART_SmartCardNACKCmd(USART_TypeDef* USARTx, INT32U NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    USARTx->CR3.Data |= CR3_NACK_Set;
  }
  else
  {
    /* Disable the NACK transmission by clearing the NACK bit in the CR3 register */
    USARTx->CR3.Data &= CR3_NACK_Reset;
  }
...
void USART_HalfDuplexCmd(USART_TypeDef* USARTx, INT32U NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    USARTx->CR3.Data |= CR3_HDSEL_Set;
  }
  else
  {
    /* Disable the Half-Duplex mode by clearing the HDSEL bit in the CR3 register */
    USARTx->CR3.Data &= CR3_HDSEL_Reset;
  }
}
...
void USART_IrDAConfig(USART_TypeDef* USARTx, u16 USART_IrDAMode)
{
  ...
  USARTx->CR3.Data &= CR3_IRLP_Mask;
  USARTx->CR3.Data |= USART_IrDAMode;
}
...
void USART_IrDACmd(USART_TypeDef* USARTx, INT32U NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    USARTx->CR3.Data |= CR3_IREN_Set;
  }
  else
  {
    /* Disable the IrDA mode by clearing the IREN bit in the CR3 register */
    USARTx->CR3.Data &= CR3_IREN_Reset;
  }
}
...
INT32U USART_GetFlagStatus(USART_TypeDef* USARTx, u16 USART_FLAG)
{
  ...
  if ((USARTx->SR.Data & USART_FLAG) != (u16)RESET)
  {
    bitstatus = SET;
  }
  else
...
INT32U USART_GetITStatus(USART_TypeDef* USARTx, u16 USART_IT)
{
  ...
  if (usartreg == 0x01) /* The IT  is in CR1 register */
  {
    itmask &= USARTx->CR1.Data;
  }
  else if (usartreg == 0x02) /* The IT  is in CR2 register */
  {
    itmask &= USARTx->CR2.Data;
  }
  else /* The IT  is in CR3 register */
  {
    itmask &= USARTx->CR3.Data;
  }
  
  bitpos = USART_IT >> 0x08;

  bitpos = (u32)0x01 << bitpos;
  bitpos &= USARTx->SR.Data;
...
void USART_ClearITPendingBit(USART_TypeDef* USARTx, u16 USART_IT)
{
  ...
  USARTx->SR.Data &= ~itmask;
}

/*******************************************************************************
* Function Name  : Write_USART_BaudRate
* Description    : Write to USART Baudrate
* Input          : - USARTx: where x can be 1, 2 or 3 to select the USART
*                    peripheral.
*                : - NewState: new state of the USARTx peripheral.
*                    This parameter can be: ENABLE or DISABLE.
...
{
	u32 tmpreg = 0x00, apbclock = SYSCLK;
	u32 intergerdivider = 0x00;
	u32 fractionaldivier = 0x00;

	// Determine the integer part
	intergerdivider = ((0x19 * apbclock) / (0x04 * (BaudRate)));
	tmpreg = (intergerdivider / 0x64);

	// Write to USART BRR DIV_Mantissa*/
	USARTx->BRR.Bit.DIV_Mantissa = tmpreg;
	  
	// Determine the fractional part */
	fractionaldivier = intergerdivider - (0x64 * (tmpreg));
	tmpreg = ((((fractionaldivier * 0x10) + 0x32) / 0x64)) & ((u8)0x0F);

	// Write to USART BRR DIV_Mantissa*/
	USARTx->BRR.Bit.DIV_Fracton = (u16) (tmpreg &0x000f);
}
