...
void I2C_Init(I2C_TypeDef* I2Cx, I2C_InitTypeDef* I2C_InitStruct)
{
  ...
  u16 result = 0x04;
  u32 pclk1clock = SYSCLK;
  RCC_ClocksTypeDef  RCC_Clocks;

/*---------------------------- I2Cx CR2 Configuration ------------------------*/
  /* Get the I2Cx CR2 value */
  tmpreg = I2Cx->CR2.Data;
...
/*---------------------------- I2Cx CCR Configuration ------------------------*/
  ...
  else /*(I2C_InitStruct->I2C_ClockSpeed <= 400000)*/
  {
    ...
    /* Set Maximum Rise Time: ((300/(1 000 000 000/pclk1clock))+1 */
    I2Cx->TRISE.Data = (u16)(((freqrange * 300) / 1000) + 1);  
  }
  /* Write to I2Cx CCR */
  I2Cx->CCR.Data = tmpreg;
...
/*---------------------------- I2Cx CR1 Configuration ------------------------*/
  ...
  /* Write to I2Cx CR1 */
  I2Cx->CR1.Data = tmpreg;

/*---------------------------- I2Cx OAR1 Configuration -----------------------*/
  /* Set I2Cx Own Address1 and acknowledged address */
  I2Cx->OAR1.Data = (I2C_InitStruct->I2C_AcknowledgedAddress | I2C_InitStruct->I2C_OwnAddress1);
}
...
void I2C_Cmd(I2C_TypeDef* I2Cx, u32 NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1.Data |= CR1_PE_Set;
  }
  else
  {
    /* Disable the selected I2C peripheral */
    I2Cx->CR1.Data &= CR1_PE_Reset;
  }
}
...
void I2C_DMACmd(I2C_TypeDef* I2Cx, u32 NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR2.Data |= CR2_DMAEN_Set;
  }
  else
  {
    /* Disable the selected I2C DMA requests */
    I2Cx->CR2.Data &= CR2_DMAEN_Reset;
  }
}
...
void I2C_DMALastTransferCmd(I2C_TypeDef* I2Cx, u32 NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR2.Data |= CR2_LAST_Set;
  }
  else
  {
    /* Next DMA end of transfer is not the last transfer */
    I2Cx->CR2.Data &= CR2_LAST_Reset;
  }
}
...
void I2C_GenerateSTART(I2C_TypeDef* I2Cx, u32 NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1.Data |= CR1_START_Set;
  }
  else
  {
    /* Disable the START condition generation */
    I2Cx->CR1.Data &= CR1_START_Reset;
  }
}
...
void I2C_GenerateSTOP(I2C_TypeDef* I2Cx, u32 NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1.Data |= CR1_STOP_Set;
  }
  else
  {
    /* Disable the STOP condition generation */
    I2Cx->CR1.Data &= CR1_STOP_Reset;
  }
}
...
void I2C_AcknowledgeConfig(I2C_TypeDef* I2Cx, u32 NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1.Data |= CR1_ACK_Set;
  }
  else
  {
    /* Disable the acknowledgement */
    I2Cx->CR1.Data &= CR1_ACK_Reset;
  }
}
...
void I2C_DualAddressCmd(I2C_TypeDef* I2Cx, u32 NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->OAR2.Data |= OAR2_ENDUAL_Set;
  }
  else
  {
    /* Disable dual addressing mode */
    I2Cx->OAR2.Data &= OAR2_ENDUAL_Reset;
  }
}
...
{
  /* Check the parameters */
  //sert_param(IS_FUNCTIONAL_STATE(NewState));

  if (NewState != DISABLE)
  {
    /* Enable generall call */
    I2Cx->CR1.Data |= CR1_ENGC_Set;
  }
  else
  {
    /* Disable generall call */
    I2Cx->CR1.Data &= CR1_ENGC_Reset;
  }
}
...
void I2C_ITConfig(I2C_TypeDef* I2Cx, u16 I2C_IT, u32 NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR2.Data |= I2C_IT;
  }
  else
  {
    /* Disable the selected I2C interrupts */
    I2Cx->CR2.Data &= (u16)~I2C_IT;
  }
}
...
void I2C_SoftwareResetCmd(I2C_TypeDef* I2Cx, u32 NewState)
{
	if (NewState != DISABLE)
	{
		...
		I2Cx->CR1.Data |= CR1_SWRST_Set;
	}
	else
	{
		// Peripheral not under reset
		I2Cx->CR1.Data &= CR1_SWRST_Reset;
	}
}
...
void I2C_SMBusAlertConfig(I2C_TypeDef* I2Cx, u16 I2C_SMBusAlert)
{
  if (I2C_SMBusAlert == I2C_SMBusAlert_Low)
  {
    ...
    I2Cx->CR1.Data |= I2C_SMBusAlert_Low;
  }
  else
  {
    /* Drive the SMBusAlert pin High  */
    I2Cx->CR1.Data &= I2C_SMBusAlert_High;
  }
}
...
void I2C_TransmitPEC(I2C_TypeDef* I2Cx, u32 NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1.Data |= CR1_PEC_Set;
  }
  else
  {
    /* Disable the selected I2C PEC transmission */
    I2Cx->CR1.Data &= CR1_PEC_Reset;
  }
}
...
void I2C_PECPositionConfig(I2C_TypeDef* I2Cx, u16 I2C_PECPosition)
{
  if (I2C_PECPosition == I2C_PECPosition_Next)
  {
    ...
    I2Cx->CR1.Data |= I2C_PECPosition_Next;
  }
  else
  {
    /* PEC indicates that the current byte in shift register is PEC */
    I2Cx->CR1.Data &= I2C_PECPosition_Current;
  }
}
...
void I2C_CalculatePEC(I2C_TypeDef* I2Cx, u32 NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1.Data |= CR1_ENPEC_Set;
  }
  else
  {
    /* Disable the selected I2C PEC calculation */
    I2Cx->CR1.Data &= CR1_ENPEC_Reset;
  }
}
...
void I2C_ARPCmd(I2C_TypeDef* I2Cx, u32 NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1.Data |= CR1_ENARP_Set;
  }
  else
  {
    /* Disable the selected I2C ARP */
    I2Cx->CR1.Data &= CR1_ENARP_Reset;
  }
}
...
void I2C_StretchClockCmd(I2C_TypeDef* I2Cx, u32 NewState)
{
  ...
  if (NewState == DISABLE)
  {
    ...
    I2Cx->CR1.Data |= CR1_NOSTRETCH_Set;
  }
  else
  {
    /* Disable the selected I2C Clock stretching */
    I2Cx->CR1.Data &= CR1_NOSTRETCH_Reset;
  }
}
...
void I2C_FastModeDutyCycleConfig(I2C_TypeDef* I2Cx, u16 I2C_DutyCycle)
{
  if (I2C_DutyCycle != I2C_DutyCycle_16_9)
  {
    ...
    I2Cx->CCR.Data &= I2C_DutyCycle_2;
  }
  else
  {
    /* I2C fast mode Tlow/Thigh=16/9 */
    I2Cx->CCR.Data |= I2C_DutyCycle_16_9;
  }
}
...
{
	// Check the parameters
	u32 Flag1 = I2Cx->SR1.Data;
	u32 Flag2 = ((I2Cx->SR2.Data << 16) & 0xffff0000) | (Flag1 & 0xffff);

	USART1Printf("Flag2: %08x \n", Flag2);
	if( (Flag2 & I2C_FLAG_Mask) == I2C_EVENT)
	{
		Flag1 = I2Cx->SR1.Data;
		Flag2 = I2Cx->SR2.Data;
		return TRUE;
...
*                       - I2C_FLAG_ADDR: Address sent flag (Master mode) “ADSL?*                                        Address matched flag (Slave mode)”ENDAD?*                       - I2C_FLAG_SB: Start bit flag (Master mode)
* Output         : None
...
*                       - I2C_IT_ADDR: Address sent flag (Master mode) “ADSL?*                                        Address matched flag (Slave mode)”ENDAD?*                       - I2C_IT_SB: Start bit flag (Master mode)
* Output         : None
