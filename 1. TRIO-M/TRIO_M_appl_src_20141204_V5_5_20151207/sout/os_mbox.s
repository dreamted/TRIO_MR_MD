...
//                    urce\os_mbox.c -D _MIMO_Type -lcN                       /
...
//    List file    =  D:\Project\TRIO\3.F_W\TRIO_appl_src_20120106\sout\os_mb /
//                    ox.s                                                    /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
// D:\Project\TRIO\3.F_W\TRIO_appl_src_20120106\uCOS-II\Source\os_mbox.c
//    1 /*
//    2 *********************************************************************************************************
//    3 *                                                uC/OS-II
...
??OSMboxPend_2:
        LDR.N    R0,??OSMboxPend_3  ;; OSLockNesting
        LDRB     R0,[R0, #+0]
        CMP      R0,#+0
        BEQ.N    ??OSMboxPend_4
...
??OSMboxPend_5:
        LDR.N    R7,??OSMboxPend_3+0x4  ;; OSTCBCur
        LDR      R0,[R7, #+0]
        LDRB     R1,[R0, #+28]
        ORR      R1,R1,#0x2
        STRB     R1,[R0, #+28]
...
//  408                      nbr_tasks++;
        ...
        UXTB     R7,R7
        LDRB     R0,[R4, #+10]
        CBZ      R0,??OSMboxPendAbort_4
        B.N      ??OSMboxPendAbort_3
//  409                  }
//  410                  break;
//  411              
