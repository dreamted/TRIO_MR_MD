///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V5.30.2.51295/W32 for ARM    09/Jan/2012  08:12:15 /
...
//                    urce\os_mem.c -D _MIMO_Type -lcN                        /
...
//    List file    =  D:\Project\TRIO\3.F_W\TRIO_appl_src_20120106\sout\os_me /
//                    m.s                                                     /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
// D:\Project\TRIO\3.F_W\TRIO_appl_src_20120106\uCOS-II\Source\os_mem.c
//    1 /*
//    2 *********************************************************************************************************
//    3 *                                                uC/OS-II
...
//  216     if (OSIntNesting > 0) {                      /* See if trying to call from an ISR                  */
        LDR.N    R0,??DataTable2  ;; OSIntNesting
        LDRB     R0,[R0, #+0]
        CMP      R0,#+0
...
//  416     OS_MemClr((INT8U *)&OSMemTbl[0], sizeof(OSMemTbl));   /* Clear the memory partition table          */
        LDR.N    R4,??OS_MemInit_0  ;; OSMemTbl
        MOVS     R1,#+180
        MOV      R0,R4
        BL       OS_MemClr
...
//  432     OSMemFreeList       = &OSMemTbl[0];                   /* Point to beginning of free list           */
        LDR.N    R0,??DataTable3  ;; OSMemFreeList
        STR      R4,[R0, #+0]
//  433 #endif
//  434 }
        POP      {R4,PC}          ;; return
