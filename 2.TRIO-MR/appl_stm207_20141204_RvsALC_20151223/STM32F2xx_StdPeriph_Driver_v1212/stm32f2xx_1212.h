...
// Exported constants ----------------------------------------------------------
#define SYSCLK				((uint32_t)120000000L)	// 120MHz
#define LSICLK				((uint32_t)32000L)		// 32KHz
#define PCLK2				((uint32_t)(SYSCLK/2))	// 60MHz
#define PCLK1				((uint32_t)(SYSCLK/4))	// 30MHz  --> ADC = 30/8 = 3.75MHz
...
#include "stm32f0xx_core.h"
#include "stm32f0xx_type.h"
#include "stm32f0xx_macro.h"
	...
	struct
	{
		...
		union {
			...
			struct {
				...
				vu32			:4;	// 
				vu32 JEXTSEL	:4;	// external event select for injected group
				vu32 JEXTEN		:2;	// External Trigger conversion mode for injected channels
				vu32 SWSTARTJ	:1;	// Start conversion of injected channel
				vu32			:1;	// 
				vu32 EXTSEL		:4;	// External Trigger select for regular group
				vu32 EXTEN		:2;	// External Trigger conersion mode for regular channels
				vu32 SWSTART	:1;	// Start Conversion of regular channel
				vu32 			:1;	// Temerature Sensor and V(REFINT) Enable
			};
...
typedef union
{
	...
	struct
	{
		union {
			vu32 Data;
			struct {
				vu32 AWD1		:1;	// Analog watchdog flag: 0: No Analog watchdog event occured
									// 						 1: Analog Watchdog event occured
				vu32 EOC1		:1;	// End of converstion	 0: conversion is not complete
									//						 1: conversion complete
				vu32 JEOC1		:1;	// injected channel end of conversion			
				vu32 JSTRT1		:1;	// injected channel start flag: 0: No Injected group converstion started
									//								1: Injected group converstion has started
				vu32 STRT1		:1;	// Regular channel start flag
				vu32 OVR1		:1;	// OverRun Flag
				vu32 			:2;
				
				vu32 AWD2		:1;	// Analog watchdog flag: 0: No Analog watchdog event occured
									// 						 1: Analog Watchdog event occured
				vu32 EOC2		:1;	// End of converstion	 0: conversion is not complete
									//						 1: conversion complete
				vu32 JEOC2		:1;	// injected channel end of conversion			
				vu32 JSTRT2		:1;	// injected channel start flag: 0: No Injected group converstion started
									//								1: Injected group converstion has started
				vu32 STRT2		:1;	// Regular channel start flag
				vu32 OVR2		:1;	// OverRun Flag
				vu32 			:2;

				vu32 AWD3		:1;	// Analog watchdog flag: 0: No Analog watchdog event occured
									// 						 1: Analog Watchdog event occured
				vu32 EOC3		:1;	// End of converstion	 0: conversion is not complete
									//						 1: conversion complete
				vu32 JEOC3		:1;	// injected channel end of conversion			
				vu32 JSTRT3		:1;	// injected channel start flag: 0: No Injected group converstion started
									//								1: Injected group converstion has started
				vu32 STRT3		:1;	// Regular channel start flag
				vu32 OVR3		:1;	// OverRun Flag

			};
		}CSR;	// ADC Status Register
	...
	struct {
		union {
			...
			struct	{
				...
				vu32 ICEN			:1;	/*!< Instruction cache enable */
				vu32 DCEN			:1; /*!< Data cache enable 0: Data cache is disabled */
				vu32 ICRST			:1; /*!< Instruction cache reset */
				vu32 DCRST			:1; /*!< Data cache reset */
			};
		...
		union {
			...
			struct	{
				...
				vu32 OPERR			:1;	/*!< End of operation */
				vu32				:2;	/*!< Operation error */
				vu32 WRPERR			:1;	/*!< Write protection error */
				vu32 PGAERR			:1;	/*!< Programming alignment error */
				vu32 PGPERR			:1;	/*!< Programming parallelism error */
				vu32 PGSERR			:1;	/*!< Programming sequence error */
				vu32				:8;
		...
		union {
			...
			struct	{
				...
				vu32 SER			:1;		//rw, Sector Erase
				vu32 MER			:1;		//rw, Mass Erase
				vu32 SNB			:4;		// Sector number
				vu32				:1;
				vu32 PSIZE			:2;		//rw, These bits select the program parallelism.
				vu32				:6;
				...
				vu32 				:5;		//rw, Option Bytes Write Enable
				vu32 LOCK			:1;		/*< Write to 1 only. When it is set, this bit indicates that the FLASH_CR register is locked. */
			};
		...
		union {
			vu32 Data;
			struct	{
				vu32 OPTLOCK		:1;		/*!< Option lock */
				vu32 OPTSTRT		:1;		/*!< Option start */
				vu32 BOR_LEV		:2;		/*!< BOR reset Level */
				vu32				:1;
				vu32 WDG_SW			:1;
				vu32 nRST_STOP		:1;
				vu32 nRSTSTDBY		:1;		/*!< User option byte */
				vu32 RDP			:8;		/*!< Read protect */

				vu32 nWRP			:12;	/*!< Not write protect, 0: write protect!! */
			};
...
typedef union{
	...
	struct
	{
		...
		} AFR;   /*!< GPIO alternate function registers,     Address offset: 0x24-0x28 */
	} __B;
	...
	struct {
		union {
			...
			struct	{
				...
				vu32 PLLI2SON	:1; // rw, PLLI2S Enable
				vu32 PLLI2SRDY	:1;	// r, PLLI2S clock ready flag
			};
		...
		union {
			vu32 Data;				// 0x04
			struct {
				vu32 PLLM 		:6; // rw, division factor for the main PLL and audio PLL (PLLi2s) input clock
				vu32 PLLN		:8; // rw, main pll multiplication factor for vco
				vu32 			:1; 				

				vu32 PLLP		:2; // rw, main pll division factor for main system clock
				vu32 			:4; // 
				vu32 PLLSRC 	:1; // rw, 0: HSI, 1: HSE
				vu32 		 	:1; //
				vu32 PLLQ		:4; // rw, main pll divistion factor for usb otg FS, SDIO and random number generator
 			};
	...
	struct {
		...
		union{
			...
			struct	{
				...
				vu32 ONEBIT		:1;	//One sample bit method enable
			};
...
/**
  * @}
  */
/** @addtogroup Exported_constant
  * @{
  */

#define BOOTSIZE				(32*1024)

#define APPLSIZE				((128-32)*1024)
#define APBKSIZE				((128-32)*1024)

#define __pBOOT					0
#define __pAPPL					(__pBOOT + BOOTSIZE)
