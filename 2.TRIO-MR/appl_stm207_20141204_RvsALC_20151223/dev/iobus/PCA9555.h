...
#define PCASetConfiguration(DevAddr,Reg)	pPCASetConfiguration(DevAddr,Reg, pPCA9555Str)
#define PCASetPortData(DevAddr,Data)		pPCASetPortData(DevAddr,Data, pPCA9555Str)
#define PCA9555SetData(pSel,Data,pVal)		pPCA9555SetData(pSel,Data,pVal,pPCA9555Str)

#define PCA9555BitSet(Bitaddr,pVal)			pPCA9555BitSet(Bitaddr,pVal,pPCA9555Str)
#define PCA9555BitRst(Bitaddr,pVal)			pPCA9555BitRst(Bitaddr,pVal,pPCA9555Str)



#define PCASetConfiguration1(DevAddr,Command,Reg)	pPCASetConfiguration1(DevAddr,Command,Reg, pPCA9555Str)
#define PCASetPortData1(DevAddr,Command,Data)		pPCASetPortData1(DevAddr,Command,Data, pPCA9555Str)
#define PCA9555SetData1(pSel,Command,Data,pVal)		pPCA9555SetData1(pSel,Command,Data,pVal,pPCA9555Str)
