/**
  ******************************************************************************
  * @file    STM32F2xx_IAP/src/stm32f2xx_it.c 
...
* Return         : None
*******************************************************************************/
#define EXTI0_IN		GPIOB->__B.IDR.B0
	
extern	void USART7Handler(void);
#include "stm32f2xx_exti.h"

void EXTI0_IRQHandler(void)
{
	INT8U tpin = GPIO_PinSource0;
...
extern	void ADC_IRQInitHandler(void);
...
* Return         : None
*******************************************************************************/
extern void USART1_IRQIntHandler(void);

void USART1_IRQHandler(void)
{
	#ifdef __STM32F2xx_USART_1
...
* Return         : None
*******************************************************************************/
extern void USART2_IRQIntHandler(void);

void USART2_IRQHandler(void)
{
	#ifdef __STM32F2xx_USART_2
...
* Return         : None
*******************************************************************************/
extern void USART3_IRQIntHandler(void);

void USART3_IRQHandler(void)
{
	#ifdef __STM32F2xx_USART_3
...
extern	void ADC3_IRQInitHandler(void);
...
* Return         : None
*******************************************************************************/
extern void USART4_IRQIntHandler(void);

void UART4_IRQHandler(void)
{
	#ifdef __STM32F2xx_USART_4
...
* Return         : None
*******************************************************************************/
extern void USART5_IRQIntHandler(void);
...
extern	void USART6_IRQIntHandler(void);
