 ...
 ******************************************************************************/
/* Modem
010-9460-8936  5C760A05
010-9460-8937  5C7E3C56    현장 
010-7106-5483  5C7DB056
1571718103
...
////////////////////
	...
	INT8U	tcp_buff[SMS_BODYSIZEMAX] = {0,};
...
//_USR_EXTSMS INT32U AutoResetCnt;
...
//_USR_EXTSMS INT32U	iCdmaCnt;
//_USR_EXTSMS INT32U	iCdmaFirstCnt;
//_USR_EXTSMS INT32U	iCdmaFirstCnt;
...
//INT8U Sms_Response_Control(INT8U* tid,INT8U Comm,__ProtocolPtr *nPtr);
