///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.21.1.52794/W32 for ARM    22/Nov/2012  02:41:04 /
// Copyright 1999-2011 IAR Systems AB.                                        /
//                                                                            /
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  D:\Work\Project\2012\NL_INBUILD\STM32F2xx_StdPeriph_Dri /
//                    ver\src\stm32f2xx_usart4_1208.c                         /
//    Command line =  D:\Work\Project\2012\NL_INBUILD\STM32F2xx_StdPeriph_Dri /
//                    ver\src\stm32f2xx_usart4_1208.c -D OS_INCLUDED -D       /
...
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC Tx4RdCnt
        PUBLIC Tx4WrCnt
        PUBLIC USART4BuffClear
        PUBLIC USART4CheckByte
        PUBLIC USART4Printf
        PUBLIC USART4PutChar
        PUBLIC USART4PutStr
        PUBLIC USART4PutToBuffer
        PUBLIC USART4RxGetByte
        PUBLIC USART4TxCheckByte
        PUBLIC USART4TxClear
        PUBLIC USART4_IRQIntHandler
        PUBLIC pUSART4
...
// D:\Work\Project\2012\NL_INBUILD\STM32F2xx_StdPeriph_Driver\src\stm32f2xx_usart4_1208.c
//    1 /**
//    2   ******************************************************************************
...
pUSART4:
        DC32 InitUSART4, USART4CheckByte, USART4RxGetByte, USART4PutStr
        DC32 USART4Printf, USART4PutChar, USART4PutToBuffer, USART4TxCheckByte
        DC32 USART4BuffClear, USART4TxClear
        DC8 0, 0, 0, 0
//  121 #endif
//  122 	InitUSART4,
//  123 	USART4CheckByte,
...
//  242 	USART_Init(UART4, &USART_InitStructure);
        LDR.N    R4,??DataTable9_3  ;; 0x40004c00
        ADD      R1,SP,#+0
        MOV      R0,R4
        BL       USART_Init
//  243 
...
//  260   *****************************************************************************/
        ...
        CFI Function USART4_IRQIntHandler
        THUMB
...
//  276 		if(++Rx4WrCnt >= Rx4BuffLen) Rx4WrCnt = 0;
        ...
        UXTH     R1,R1
        CMP      R1,#+1024
        BCC.N    ??USART4_IRQIntHandler_1
        MOVS     R1,#+0
        STRH     R1,[R0, #+2]
        B.N      ??USART4_IRQIntHandler_1
//  277 	}
//  278 	else if(tmp & ( 1 << __TXE))
??USART4_IRQIntHandler_0:
        LSLS     R0,R5,#+24
        BPL.N    ??USART4_IRQIntHandler_2
//  279 	{
...
//  297 
        ...
        CFI Function USART4PutToBuffer
        THUMB
...
//  310 	UART4->__B.CR1.TXEIE = ENABLE; 		
        LDR.N    R0,??DataTable9_8  ;; 0x40004c0c
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x80
        STR      R1,[R0, #+0]
//  311 	///////////////////////////////////////////////////
...
//  330 		UART4->__B.DR.DR = Data;
        LDR.N    R0,??DataTable9_3  ;; 0x40004c00
        LDR      R1,[R0, #+4]
        BFI      R1,R4,#+0,#+9
        STR      R1,[R0, #+4]
...
??USART4Printf_1:
        ...
        ITT      EQ 
        MOVEQ    R0,#+13
        BLEQ     USART4PutToBuffer
//  352 		USART4PutToBuffer(buf[i]);
        LDRB     R0,[R5], #+1
        BL       USART4PutToBuffer
??USART4Printf_0:
        LDRB     R0,[R5, #+0]
        CMP      R0,#+0
        BNE.N    ??USART4Printf_1
//  353 	}
//  354 	while(!USART4TxCheckByte())
??USART4Printf_2:
        BL       USART4TxCheckByte
        CBNZ.N   R0,??USART4Printf_3
//  355 	{
...
//  364 
        ...
        CFI Function USART4PutStr
        THUMB
//  365 void USART4PutStr(unsigned char *Str, unsigned short int Length, int iEn)
//  366 {
USART4PutStr:
        PUSH     {R3-R7,LR}
        CFI R14 Frame(CFA, -4)
...
//  372 	INT8U err;
//  373 	OSSemPend(pUSART4.sem, 0, &err);
        LDR.N    R4,??DataTable9_4
        ADD      R2,SP,#+0
        MOVS     R1,#+0
        LDR      R0,[R4, #+48]
...
//  377 	for(i = 0; i < Length; i++)
        LDRH     R0,[R4, #+6]
        CBZ.N    R6,??USART4PutStr_0
        LDR.N    R1,??DataTable9_7
//  378 	{
//  379 		Tx4Buff[Tx4WrCnt++] = Str[i];
??USART4PutStr_1:
        LDRB     R2,[R5, #+0]
        STRB     R2,[R0, R1]
        ADDS     R0,R0,#+1
//  380 		if(Tx4WrCnt >= Tx4BuffLen) Tx4WrCnt = 0;
        UXTH     R0,R0
        CMP      R0,#+1024
        IT       CS 
        MOVCS    R0,#+0
//  381 	}
        ADDS     R5,R5,#+1
        SUBS     R6,R6,#+1
        BNE.N    ??USART4PutStr_1
??USART4PutStr_0:
        STRH     R0,[R4, #+6]
//  382 
//  383 	if(iEn)
        CBZ.N    R7,??USART4PutStr_2
//  384 	{
//  385 		UART4->__B.CR1.TXEIE = ENABLE;
        LDR.N    R0,??DataTable9_8  ;; 0x40004c0c
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x80
        STR      R1,[R0, #+0]
...
//  391 
        ...
        CFI Function USART4RxGetByte
        THUMB
//  392 signed short int USART4RxGetByte(void)
//  393 {
//  394 	s16 RetVal = 0;
//  395 
//  396 #ifndef APPL_SRC
//  397 	while(Rx4RdCnt == Rx4WrCnt);
//  398 #else
//  399 	if(Rx4RdCnt == Rx4WrCnt) return -1;
USART4RxGetByte:
        LDR.N    R1,??DataTable9_4
        LDRH     R2,[R1, #+0]
        LDRH     R0,[R1, #+2]
        CMP      R2,R0
        BNE.N    ??USART4RxGetByte_0
        MOV      R0,#-1
        BX       LR
//  400 #endif
//  401 
//  402 	RetVal = Rx4Buff[Rx4RdCnt%Rx4BuffLen];
??USART4RxGetByte_0:
        LSLS     R0,R2,#+22
        LSRS     R0,R0,#+22
        LDR.N    R3,??DataTable9_6
        LDRB     R0,[R0, R3]
//  403 	if(++Rx4RdCnt >= Rx4BuffLen) Rx4RdCnt = 0;
        ADDS     R2,R2,#+1
        STRH     R2,[R1, #+0]
        UXTH     R2,R2
        CMP      R2,#+1024
        BCC.N    ??USART4RxGetByte_1
        MOVS     R2,#+0
        STRH     R2,[R1, #+0]
//  404 
...
//  407 
        ...
        CFI Function USART4CheckByte
        THUMB
//  408 unsigned char USART4CheckByte(unsigned short int ByteCnt, unsigned short int *Recv)
//  409 {
USART4CheckByte:
        PUSH     {R4,R5}
        CFI R5 Frame(CFA, -4)
...
//  417 	if(i == j) RetVal = FALSE;
        CMP      R4,R3
        BEQ.N    ??USART4CheckByte_0
//  418 	else if(i < j)
        ADDS     R0,R0,R4
        CMP      R4,R3
        BCS.N    ??USART4CheckByte_1
//  419 	{
//  420 		*Recv = j - i;
        SUBS     R4,R3,R4
        STRH     R4,[R1, #+0]
...
//  422 		if(i > j) RetVal = FALSE;
        CMP      R3,R0
        BCS.N    ??USART4CheckByte_2
        B.N      ??USART4CheckByte_0
//  423 	}
//  424 	else if(i > j)
//  425 	{
//  426 		*Recv = (Rx4BuffLen +j) - i;
??USART4CheckByte_1:
        ADD      R5,R3,#+1024
        SUBS     R4,R5,R4
        STRH     R4,[R1, #+0]
...
//  433 
        ...
        CFI Function USART4BuffClear
        THUMB
//  434 void USART4BuffClear(void)
//  435 {
//  436 	Rx4RdCnt = 0;
USART4BuffClear:
        LDR.N    R0,??DataTable9_4
...
//  441 
        ...
        CFI Function USART4TxClear
        THUMB
//  442 void USART4TxClear(void)
//  443 {
//  444 	Tx4RdCnt = 0;
USART4TxClear:
        LDR.N    R0,??DataTable9_4
...
//  453 
        ...
        CFI Function USART4TxCheckByte
        THUMB
//  454 signed short int USART4TxCheckByte(void)
//  455 {
//  456 	if(Tx4RdCnt == Tx4WrCnt) return TRUE;
USART4TxCheckByte:
        LDR.N    R0,??DataTable9_4
        LDRH     R1,[R0, #+4]
        LDRH     R0,[R0, #+6]
        CMP      R1,R0
        BNE.N    ??USART4TxCheckByte_0
        MOVS     R0,#+1
        BX       LR
