...
//                    ver\src\stm32f2xx_usart6_1208.c                         /
//    Command line =  D:\Work\Project\2012\NL_INBUILD\STM32F2xx_StdPeriph_Dri /
//                    ver\src\stm32f2xx_usart6_1208.c -D OS_INCLUDED -D       /
...
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC Tx6RdCnt
        PUBLIC Tx6WrCnt
        PUBLIC USART6BuffClear
        PUBLIC USART6CheckByte
        PUBLIC USART6Printf
        PUBLIC USART6PutChar
        PUBLIC USART6PutStr
        PUBLIC USART6PutToBuffer
        PUBLIC USART6RxGetByte
        PUBLIC USART6TxCheckByte
        PUBLIC USART6TxClear
        PUBLIC USART6_IRQIntHandler
        PUBLIC pUSART6
...
// D:\Work\Project\2012\NL_INBUILD\STM32F2xx_StdPeriph_Driver\src\stm32f2xx_usart6_1208.c
//    1 /**
//    2   ******************************************************************************
...
//   83 
//   84 /* Includes ------------------------------------------------------------------*/
//   85 #include "stm32f2xx_usart6_1208.h"
//   86 
...
//  103 	INT8U Rx6Buff[Rx6BuffLen];
//  104 	INT8U Tx6Buff[Tx6BuffLen];
//  105 
//  106 	INT16U	Rx6RdCnt = 0, Rx6WrCnt = 0;
//  107 	INT16U	Tx6RdCnt = 0, Tx6WrCnt = 0;
//  108 #else

        SECTION iram:DATA:REORDER:NOROOT(2)
//  109 	INT8U Rx6Buff[Rx6BuffLen] @ "iram";
Rx6Buff:
        DS8 2048

        SECTION iram:DATA:REORDER:NOROOT(2)
//  110 	INT8U Tx6Buff[Tx6BuffLen] @ "iram";
Tx6Buff:
        DS8 2048
//  111 

        SECTION iram:DATA:REORDER:NOROOT(2)
//  112 	INT16U	Rx6RdCnt @ "iram"= 0, Rx6WrCnt @ "iram" = 0;
Rx6RdCnt:
        DATA
        DC16 0
Rx6WrCnt:
        DC16 0
//  113 	INT16U	Tx6RdCnt @ "iram"= 0, Tx6WrCnt @ "iram" = 0;
Tx6RdCnt:
        DC16 0
Tx6WrCnt:
        DC16 0
...
//  117 __SerStrPtr pUSART6 = {
//  118 
//  119 #else
//  120 __SerStrPtr pUSART6 @ "iram" = {
pUSART6:
        DC32 InitUSART6, USART6CheckByte, USART6RxGetByte, USART6PutStr
        DC32 USART6Printf, USART6PutChar, USART6PutToBuffer, USART6TxCheckByte
        DC32 USART6BuffClear, USART6TxClear
        DC8 0, 0, 0, 0
//  121 #endif
//  122 	InitUSART6,
//  123 	USART6CheckByte,
...
//  126 	USART6Printf,
//  127 	USART6PutChar,
//  128 	USART6PutToBuffer,
//  129 	USART6TxCheckByte,
//  130 	USART6BuffClear,
//  131 	USART6TxClear
//  132 };
...
//  193   */
        ...
        CFI Function InitUSART6
        THUMB
//  194 void InitUSART6(INT32U nBps, INT32U nLCR)
//  195 {
InitUSART6:
        PUSH     {R4-R6,LR}
        CFI R14 Frame(CFA, -4)
...
//  200 	RCC->__B.AHB1ENR.IOPCEN = ENABLE;
        ...
        ORR      R1,R1,#0x4
        STR      R1,[R0, #+0]
//  201 	RCC->__B.APB2ENR.USART6EN = ENABLE;
        LDR      R1,[R0, #+20]
        ORR      R1,R1,#0x20
        STR      R1,[R0, #+20]
//  202 	
//  203 	__PC6_U6_TX();				// USART6_TX
        LDR.N    R6,??DataTable9_2  ;; 0x40020800
        MOVS     R3,#+6
        MOV      R2,R6
        MOVS     R1,#+8
        MOVS     R0,#+38
        BL       GPIOPortInit
//  204 	__PC7_U6_RX(); 				// USART6_RX
        MOVS     R3,#+7
        MOV      R2,R6
        MOVS     R1,#+8
        MOVS     R0,#+38
...
//  242 	USART_Init(USART6, &USART_InitStructure);
        LDR.N    R4,??DataTable9_3  ;; 0x40011400
        ADD      R1,SP,#+0
        MOV      R0,R4
        BL       USART_Init
//  243 
//  244 #if defined (OS_INCLUDED) 
//  245 	pUSART6.sem = OSSemCreate(1);
        MOVS     R0,#+1
        BL       OSSemCreate
...
//  246 #endif
//  247 	/* Enable USART */
//  248 	USART_Cmd(USART6, ENABLE);
        MOVS     R1,#+1
        MOV      R0,R4
        BL       USART_Cmd
//  249 
//  250 	USART_ITConfig(USART6, USART_IT_RXNE, ENABLE);
        MOVS     R2,#+1
        MOVW     R1,#+1317
        MOV      R0,R4
        BL       USART_ITConfig
//  251 	NVIC_Init(USART6_IRQn, ENABLE); 
        MOVS     R1,#+1
        MOVS     R0,#+71
        BL       NVIC_Init
//  252 
...
//  255 
//  256 /*******************************************************************************
//  257   * @brief  Interrupt handler USART6 global interrupt request
//  258   * @param  None 
//  259   * @retval None
//  260   *****************************************************************************/
        ...
        CFI Function USART6_IRQIntHandler
        THUMB
//  261 void USART6_IRQIntHandler(void)
//  262 {
USART6_IRQIntHandler:
        PUSH     {R3-R5,LR}
        CFI R14 Frame(CFA, -4)
        CFI R5 Frame(CFA, -8)
        CFI R4 Frame(CFA, -12)
...
//  273 	if(tmp & ( 1 << __RXNE))
        LSLS     R0,R5,#+26
        BPL.N    ??USART6_IRQIntHandler_0
//  274 	{
//  275 		Rx6Buff[Rx6WrCnt%Rx6BuffLen] = USART6->DR;		// When the receive register is read, the RDR bit is automatically cleared.
        ...
        LDRH     R4,[R4, #+4]
        STRB     R4,[R2, R3]
//  276 		if(++Rx6WrCnt >= Rx6BuffLen) Rx6WrCnt = 0;
        ADDS     R1,R1,#+1
        STRH     R1,[R0, #+2]
        UXTH     R1,R1
        CMP      R1,#+2048
        BCC.N    ??USART6_IRQIntHandler_1
        MOVS     R1,#+0
        STRH     R1,[R0, #+2]
        B.N      ??USART6_IRQIntHandler_1
//  277 	}
//  278 	else if(tmp & ( 1 << __TXE))
??USART6_IRQIntHandler_0:
        LSLS     R0,R5,#+24
        BPL.N    ??USART6_IRQIntHandler_2
//  279 	{
//  280 		if(Tx6RdCnt != Tx6WrCnt)
        LDR.N    R0,??DataTable9_4
        LDRH     R1,[R0, #+4]
        LDRH     R2,[R0, #+6]
        CMP      R1,R2
        BEQ.N    ??USART6_IRQIntHandler_3
//  281 		{
//  282 			USART6->DR = Tx6Buff[Tx6RdCnt%Tx6BuffLen];
        LSLS     R1,R1,#+21
        LSRS     R1,R1,#+21
        LDR.N    R2,??DataTable9_7
        LDRB     R1,[R1, R2]
        STRH     R1,[R4, #+4]
//  283 			if(++Tx6RdCnt >= Tx6BuffLen ) Tx6RdCnt = 0;
        LDRH     R1,[R0, #+4]
        ADDS     R1,R1,#+1
        STRH     R1,[R0, #+4]
        UXTH     R1,R1
        ...
        B.N      ??USART6_IRQIntHandler_1
//  284 		}
//  285 		else USART6->__B.CR1.TXEIE = DISABLE;
??USART6_IRQIntHandler_3:
        LDR      R0,[R4, #+12]
        BIC      R0,R0,#0x80
        STR      R0,[R4, #+12]
        B.N      ??USART6_IRQIntHandler_1
...
//  297 
        ...
        CFI Function USART6PutToBuffer
        THUMB
//  298 unsigned char USART6PutToBuffer(unsigned char Data)
//  299 {
USART6PutToBuffer:
        PUSH     {R3-R5,LR}
        CFI R14 Frame(CFA, -4)
...
//  302 	//////////////////////////////////////////////////
//  303 
//  304 	OSSemPend(pUSART6.sem, 0, &err);
...
//  306 	//////////////////////////////////////////////////
//  307 	Tx6Buff[Tx6WrCnt%Tx6BuffLen] = Data;
        LDRH     R0,[R4, #+6]
        LSLS     R1,R0,#+21
        LSRS     R1,R1,#+21
        LDR.N    R2,??DataTable9_7
        STRB     R5,[R1, R2]
//  308 	if(++Tx6WrCnt >= Tx6BuffLen) Tx6WrCnt = 0;
        ADDS     R0,R0,#+1
        UXTH     R0,R0
        CMP      R0,#+2048
        IT       CS 
        ...
        STRH     R0,[R4, #+6]
//  309 	
//  310 	USART6->__B.CR1.TXEIE = ENABLE; 		
        LDR.N    R0,??DataTable9_8  ;; 0x4001140c
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x80
        STR      R1,[R0, #+0]
//  311 	///////////////////////////////////////////////////
//  312 #ifdef OS_INCLUDED
//  313 	OSSemPost(pUSART6.sem);
        LDR      R0,[R4, #+48]
        BL       OSSemPost
...
//  321 //Not using interrupt
        ...
        CFI Function USART6PutChar
        THUMB
//  322 unsigned char USART6PutChar(unsigned char Data)
//  323 {
USART6PutChar:
        PUSH     {R3-R5,LR}
        CFI R14 Frame(CFA, -4)
...
//  326 		//////////////////////////////////////////////////
//  327 	
//  328 		OSSemPend(pUSART6.sem, 0, &err);
...
//  330 		USART6->__B.DR.DR = Data;
        LDR.N    R0,??DataTable9_3  ;; 0x40011400
        LDR      R1,[R0, #+4]
        BFI      R1,R4,#+0,#+9
        STR      R1,[R0, #+4]
//  331 		while(!USART6->__B.SR.TXE);
??USART6PutChar_0:
        LDR      R1,[R0, #+0]
        LSLS     R1,R1,#+24
        BPL.N    ??USART6PutChar_0
//  332 	#ifdef OS_INCLUDED
//  333 		OSSemPost(pUSART6.sem);
        LDR      R0,[R5, #+48]
        BL       OSSemPost
...
//  337 
        ...
        CFI Function USART6Printf
        THUMB
//  338 unsigned long int USART6Printf( const char *format, ...)
//  339 {
USART6Printf:
        PUSH     {R1-R3}
        CFI CFA R13+12
...
??USART6Printf_1:
        ...
        ITT      EQ 
        MOVEQ    R0,#+13
        BLEQ     USART6PutToBuffer
//  352 		USART6PutToBuffer(buf[i]);
        LDRB     R0,[R5], #+1
        BL       USART6PutToBuffer
??USART6Printf_0:
        LDRB     R0,[R5, #+0]
        CMP      R0,#+0
        BNE.N    ??USART6Printf_1
//  353 	}
//  354 	while(!USART6TxCheckByte())
??USART6Printf_2:
        BL       USART6TxCheckByte
        CBNZ.N   R0,??USART6Printf_3
//  355 	{
...
//  364 
        ...
        CFI Function USART6PutStr
        THUMB
//  365 void USART6PutStr(unsigned char *Str, unsigned short int Length, int iEn)
//  366 {
USART6PutStr:
        PUSH     {R3-R7,LR}
        CFI R14 Frame(CFA, -4)
...
//  372 	INT8U err;
//  373 	OSSemPend(pUSART6.sem, 0, &err);
        LDR.N    R4,??DataTable9_4
        ADD      R2,SP,#+0
        MOVS     R1,#+0
        LDR      R0,[R4, #+48]
...
//  377 	for(i = 0; i < Length; i++)
        LDRH     R0,[R4, #+6]
        CBZ.N    R6,??USART6PutStr_0
        LDR.N    R1,??DataTable9_7
//  378 	{
//  379 		Tx6Buff[Tx6WrCnt++] = Str[i];
??USART6PutStr_1:
        LDRB     R2,[R5, #+0]
        STRB     R2,[R0, R1]
        ADDS     R0,R0,#+1
//  380 		if(Tx6WrCnt >= Tx6BuffLen) Tx6WrCnt = 0;
        UXTH     R0,R0
        CMP      R0,#+2048
        IT       CS 
        MOVCS    R0,#+0
//  381 	}
        ADDS     R5,R5,#+1
        SUBS     R6,R6,#+1
        BNE.N    ??USART6PutStr_1
??USART6PutStr_0:
        STRH     R0,[R4, #+6]
//  382 
//  383 	if(iEn)
        CBZ.N    R7,??USART6PutStr_2
//  384 	{
//  385 		USART6->__B.CR1.TXEIE = ENABLE;
        LDR.N    R0,??DataTable9_8  ;; 0x4001140c
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x80
        STR      R1,[R0, #+0]
...
//  391 
        ...
        CFI Function USART6RxGetByte
        THUMB
//  392 signed short int USART6RxGetByte(void)
//  393 {
//  394 	s16 RetVal = 0;
//  395 
//  396 #ifndef APPL_SRC
//  397 	while(Rx6RdCnt == Rx6WrCnt);
//  398 #else
//  399 	if(Rx6RdCnt == Rx6WrCnt) return -1;
USART6RxGetByte:
        LDR.N    R1,??DataTable9_4
        LDRH     R2,[R1, #+0]
        LDRH     R0,[R1, #+2]
        CMP      R2,R0
        BNE.N    ??USART6RxGetByte_0
        MOV      R0,#-1
        BX       LR
//  400 #endif
//  401 
//  402 	RetVal = Rx6Buff[Rx6RdCnt%Rx6BuffLen];
??USART6RxGetByte_0:
        LSLS     R0,R2,#+21
        LSRS     R0,R0,#+21
        LDR.N    R3,??DataTable9_6
        LDRB     R0,[R0, R3]
//  403 	if(++Rx6RdCnt >= Rx6BuffLen) Rx6RdCnt = 0;
        ADDS     R2,R2,#+1
        STRH     R2,[R1, #+0]
        UXTH     R2,R2
        CMP      R2,#+2048
        BCC.N    ??USART6RxGetByte_1
        MOVS     R2,#+0
        STRH     R2,[R1, #+0]
//  404 
...
//  407 
        ...
        CFI Function USART6CheckByte
        THUMB
//  408 unsigned char USART6CheckByte(unsigned short int ByteCnt, unsigned short int *Recv)
//  409 {
USART6CheckByte:
        PUSH     {R4,R5}
        CFI R5 Frame(CFA, -4)
...
//  417 	if(i == j) RetVal = FALSE;
        CMP      R4,R3
        BEQ.N    ??USART6CheckByte_0
//  418 	else if(i < j)
        ADDS     R0,R0,R4
        CMP      R4,R3
        BCS.N    ??USART6CheckByte_1
//  419 	{
//  420 		*Recv = j - i;
        SUBS     R4,R3,R4
        STRH     R4,[R1, #+0]
...
//  422 		if(i > j) RetVal = FALSE;
        CMP      R3,R0
        BCS.N    ??USART6CheckByte_2
        B.N      ??USART6CheckByte_0
//  423 	}
//  424 	else if(i > j)
//  425 	{
//  426 		*Recv = (Rx6BuffLen +j) - i;
??USART6CheckByte_1:
        ADD      R5,R3,#+2048
        SUBS     R4,R5,R4
        STRH     R4,[R1, #+0]
...
//  433 
        ...
        CFI Function USART6BuffClear
        THUMB
//  434 void USART6BuffClear(void)
//  435 {
//  436 	Rx6RdCnt = 0;
USART6BuffClear:
        LDR.N    R0,??DataTable9_4
...
//  441 
        ...
        CFI Function USART6TxClear
        THUMB
//  442 void USART6TxClear(void)
//  443 {
//  444 	Tx6RdCnt = 0;
USART6TxClear:
        LDR.N    R0,??DataTable9_4
...
//  453 
        ...
        CFI Function USART6TxCheckByte
        THUMB
//  454 signed short int USART6TxCheckByte(void)
//  455 {
//  456 	if(Tx6RdCnt == Tx6WrCnt) return TRUE;
USART6TxCheckByte:
        LDR.N    R0,??DataTable9_4
        LDRH     R1,[R0, #+4]
        LDRH     R0,[R0, #+6]
        CMP      R1,R0
        BNE.N    ??USART6TxCheckByte_0
        MOVS     R0,#+1
        BX       LR
