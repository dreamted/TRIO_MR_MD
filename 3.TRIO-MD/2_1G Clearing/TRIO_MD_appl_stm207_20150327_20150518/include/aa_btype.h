...
#define RCUID				0x00			//////20150327
#define FPGAID				0x01
#define FILTERID			0x02
#define DNTESTID			0x03
...
#define	ModuleDownloadCMD				0xE0
#define	ModuleDownloadCMDConfirm		0xE1
#define	ModuleDownLoadData				0xE2
#define	ModuleDownLoadDataConfirm		0xE3



#define	FastDownloadCMD				0x70
#define	FastDownLoadData			0x71
#define	FastDownLoadDataRSPS		0x61

#define	FastDownLoadDataConfirm		0x72
...
#define BODYSIZEMAX			2500			// Body data Max 11K
#define SMSBODYSIZEMAX		2024			// Body data Max 11K
...
typedef struct {
	...
	INT8U SerCnt;			//<! to check recved protocol buffer
	INT8U SendFlag;
	INT8U CtrlTx;
