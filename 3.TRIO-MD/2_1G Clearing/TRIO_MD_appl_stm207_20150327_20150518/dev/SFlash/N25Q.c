...
*******************************************************************************/
ReturnType FlashDataRead( uAddrType udAddr, NMX_uint8 *ucpElements, NMX_uint32 udNrOfElementsToRead, InstructionType insInstruction) {
    CharStream char_stream_send;
    CharStream char_stream_recv;
