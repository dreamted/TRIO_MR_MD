...
#define MEM_TYPE_N25Q512	0x20BA20	/* ID for N25Q 512M device */
...
ReturnType Driver_Init(FLASH_DEVICE_OBJECT *fdo);
...
ReturnType FlashGenProgram(NMX_uint32 udAddr, NMX_uint8 *pArray , NMX_uint32 udNrOfElementsInArray, NMX_uint8 ubSpiInstruction);
...
ReturnType FlashDataRead(uAddrType udAddr, NMX_uint8 *pArray , NMX_uint32 udNrOfElementsToRead, NMX_uint8 ubSpiInstruction);
...
ReturnType FlashWriteVolatileEnhancedConfigurationRegister(NMX_uint8 ucpVolatileEnhancedConfigurationRegister);
