///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.21.1.52794/W32 for ARM    29/Oct/2012  10:52:06 /
// Copyright 1999-2011 IAR Systems AB.                                        /
//                                                                            /
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  D:\Work\Project\2012\NL_INBUILD\STM32F2xx_StdPeriph_Dri /
//                    ver\src\stm32f2xx_usart3_1208.c                         /
//    Command line =  D:\Work\Project\2012\NL_INBUILD\STM32F2xx_StdPeriph_Dri /
//                    ver\src\stm32f2xx_usart3_1208.c -D OS_INCLUDED -D       /
...
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC Tx3RdCnt
        PUBLIC Tx3WrCnt
        PUBLIC USART3BuffClear
        PUBLIC USART3CheckByte
        PUBLIC USART3Printf
        PUBLIC USART3PutChar
        PUBLIC USART3PutStr
        PUBLIC USART3PutToBuffer
        PUBLIC USART3RxGetByte
        PUBLIC USART3TxCheckByte
        PUBLIC USART3TxClear
        PUBLIC USART3_IRQIntHandler
        PUBLIC pUSART3
...
// D:\Work\Project\2012\NL_INBUILD\STM32F2xx_StdPeriph_Driver\src\stm32f2xx_usart3_1208.c
//    1 /**
//    2   ******************************************************************************
...
//   83 
//   84 /* Includes ------------------------------------------------------------------*/
//   85 #include "stm32f2xx_usart3_1208.h"
//   86 
...
//  103 	INT8U Rx3Buff[Rx3BuffLen];
//  104 	INT8U Tx3Buff[Tx3BuffLen];
//  105 
//  106 	INT16U	Rx3RdCnt = 0, Rx3WrCnt = 0;
//  107 	INT16U	Tx3RdCnt = 0, Tx3WrCnt = 0;
//  108 #else

        SECTION iram:DATA:REORDER:NOROOT(2)
//  109 	INT8U Rx3Buff[Rx3BuffLen] @ "iram";
Rx3Buff:
        DS8 2048

        SECTION iram:DATA:REORDER:NOROOT(2)
//  110 	INT8U Tx3Buff[Tx3BuffLen] @ "iram";
Tx3Buff:
        DS8 2048
//  111 

        SECTION iram:DATA:REORDER:NOROOT(2)
//  112 	INT16U	Rx3RdCnt @ "iram"= 0, Rx3WrCnt @ "iram" = 0;
Rx3RdCnt:
        DATA
        DC16 0
Rx3WrCnt:
        DC16 0
//  113 	INT16U	Tx3RdCnt @ "iram"= 0, Tx3WrCnt @ "iram" = 0;
Tx3RdCnt:
        DC16 0
Tx3WrCnt:
        DC16 0
...
//  117 __SerStrPtr pUSART3 = {
//  118 
//  119 #else
//  120 __SerStrPtr pUSART3 @ "iram" = {
pUSART3:
        DC32 InitUSART3, USART3CheckByte, USART3RxGetByte, USART3PutStr
        DC32 USART3Printf, USART3PutChar, USART3PutToBuffer, USART3TxCheckByte
        DC32 USART3BuffClear, USART3TxClear
        DC8 0, 0, 0, 0
//  121 #endif
//  122 	InitUSART3,
//  123 	USART3CheckByte,
...
//  126 	USART3Printf,
//  127 	USART3PutChar,
//  128 	USART3PutToBuffer,
//  129 	USART3TxCheckByte,
//  130 	USART3BuffClear,
//  131 	USART3TxClear
//  132 };
...
//  193   */
        ...
        CFI Function InitUSART3
        THUMB
//  194 void InitUSART3(INT32U nBps, INT32U nLCR)
//  195 {
InitUSART3:
        PUSH     {R4-R6,LR}
        CFI R14 Frame(CFA, -4)
...
//  198 ///
//  199 // PORT INIT
//  200 	RCC->__B.AHB1ENR.IOPBEN = ENABLE;
        LDR.N    R0,??DataTable9_1  ;; 0x40023830
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x2
        STR      R1,[R0, #+0]
//  201 	RCC->__B.APB1ENR.USART3EN = ENABLE;
        LDR      R1,[R0, #+16]
        ORR      R1,R1,#0x40000
        STR      R1,[R0, #+16]
//  202 	
//  203 	__PB10_U3_TX(); 			// USART3_TX
        LDR.N    R6,??DataTable9_2  ;; 0x40020400
        MOVS     R3,#+10
        MOV      R2,R6
        MOVS     R1,#+7
        MOVS     R0,#+38
        BL       GPIOPortInit
//  204 	__PB11_U3_RX(); 			// USART3_RX
        MOVS     R3,#+11
        MOV      R2,R6
        MOVS     R1,#+7
        MOVS     R0,#+38
...
//  242 	USART_Init(USART3, &USART_InitStructure);
        LDR.N    R4,??DataTable9_3  ;; 0x40004800
        ADD      R1,SP,#+0
        MOV      R0,R4
        BL       USART_Init
//  243 
//  244 #if defined (OS_INCLUDED) 
//  245 	pUSART3.sem = OSSemCreate(1);
        MOVS     R0,#+1
        BL       OSSemCreate
...
//  246 #endif
//  247 	/* Enable USART */
//  248 	USART_Cmd(USART3, ENABLE);
        MOVS     R1,#+1
        MOV      R0,R4
        BL       USART_Cmd
//  249 
//  250 	USART_ITConfig(USART3, USART_IT_RXNE, ENABLE);
        MOVS     R2,#+1
        MOVW     R1,#+1317
        MOV      R0,R4
        BL       USART_ITConfig
//  251 	NVIC_Init(USART3_IRQn, ENABLE); 
        MOVS     R1,#+1
        MOVS     R0,#+39
        BL       NVIC_Init
//  252 
...
//  255 
//  256 /*******************************************************************************
//  257   * @brief  Interrupt handler USART3 global interrupt request
//  258   * @param  None 
//  259   * @retval None
//  260   *****************************************************************************/
        ...
        CFI Function USART3_IRQIntHandler
        THUMB
//  261 void USART3_IRQIntHandler(void)
//  262 {
USART3_IRQIntHandler:
        PUSH     {R3-R5,LR}
        CFI R14 Frame(CFA, -4)
        CFI R5 Frame(CFA, -8)
        CFI R4 Frame(CFA, -12)
...
//  273 	if(tmp & ( 1 << __RXNE))
        LSLS     R0,R5,#+26
        BPL.N    ??USART3_IRQIntHandler_0
//  274 	{
//  275 		Rx3Buff[Rx3WrCnt%Rx3BuffLen] = USART3->DR;		// When the receive register is read, the RDR bit is automatically cleared.
        ...
        LDRH     R4,[R4, #+4]
        STRB     R4,[R2, R3]
//  276 		if(++Rx3WrCnt >= Rx3BuffLen) Rx3WrCnt = 0;
        ADDS     R1,R1,#+1
        STRH     R1,[R0, #+2]
        UXTH     R1,R1
        CMP      R1,#+2048
        BCC.N    ??USART3_IRQIntHandler_1
        MOVS     R1,#+0
        STRH     R1,[R0, #+2]
        B.N      ??USART3_IRQIntHandler_1
//  277 	}
//  278 	else if(tmp & ( 1 << __TXE))
??USART3_IRQIntHandler_0:
        LSLS     R0,R5,#+24
        BPL.N    ??USART3_IRQIntHandler_2
//  279 	{
//  280 		if(Tx3RdCnt != Tx3WrCnt)
        LDR.N    R0,??DataTable9_4
        LDRH     R1,[R0, #+4]
        LDRH     R2,[R0, #+6]
        CMP      R1,R2
        BEQ.N    ??USART3_IRQIntHandler_3
//  281 		{
//  282 			USART3->DR = Tx3Buff[Tx3RdCnt%Tx3BuffLen];
        LSLS     R1,R1,#+21
        LSRS     R1,R1,#+21
        LDR.N    R2,??DataTable9_7
        LDRB     R1,[R1, R2]
        STRH     R1,[R4, #+4]
//  283 			if(++Tx3RdCnt >= Tx3BuffLen ) Tx3RdCnt = 0;
        LDRH     R1,[R0, #+4]
        ADDS     R1,R1,#+1
        STRH     R1,[R0, #+4]
        UXTH     R1,R1
        ...
        B.N      ??USART3_IRQIntHandler_1
//  284 		}
//  285 		else USART3->__B.CR1.TXEIE = DISABLE;
??USART3_IRQIntHandler_3:
        LDR      R0,[R4, #+12]
        BIC      R0,R0,#0x80
        STR      R0,[R4, #+12]
        B.N      ??USART3_IRQIntHandler_1
...
//  297 
        ...
        CFI Function USART3PutToBuffer
        THUMB
//  298 unsigned char USART3PutToBuffer(unsigned char Data)
//  299 {
USART3PutToBuffer:
        PUSH     {R3-R5,LR}
        CFI R14 Frame(CFA, -4)
...
//  302 	//////////////////////////////////////////////////
//  303 
//  304 	OSSemPend(pUSART3.sem, 0, &err);
...
//  306 	//////////////////////////////////////////////////
//  307 	Tx3Buff[Tx3WrCnt%Tx3BuffLen] = Data;
        LDRH     R0,[R4, #+6]
        LSLS     R1,R0,#+21
        LSRS     R1,R1,#+21
        LDR.N    R2,??DataTable9_7
        STRB     R5,[R1, R2]
//  308 	if(++Tx3WrCnt >= Tx3BuffLen) Tx3WrCnt = 0;
        ADDS     R0,R0,#+1
        UXTH     R0,R0
        CMP      R0,#+2048
        IT       CS 
        ...
        STRH     R0,[R4, #+6]
//  309 	
//  310 	USART3->__B.CR1.TXEIE = ENABLE; 		
        LDR.N    R0,??DataTable9_8  ;; 0x4000480c
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x80
        STR      R1,[R0, #+0]
//  311 	///////////////////////////////////////////////////
//  312 #ifdef OS_INCLUDED
//  313 	OSSemPost(pUSART3.sem);
        LDR      R0,[R4, #+48]
        BL       OSSemPost
...
//  321 //Not using interrupt
        ...
        CFI Function USART3PutChar
        THUMB
//  322 unsigned char USART3PutChar(unsigned char Data)
//  323 {
USART3PutChar:
        PUSH     {R3-R5,LR}
        CFI R14 Frame(CFA, -4)
...
//  326 		//////////////////////////////////////////////////
//  327 	
//  328 		OSSemPend(pUSART3.sem, 0, &err);
...
//  330 		USART3->__B.DR.DR = Data;
        LDR.N    R0,??DataTable9_3  ;; 0x40004800
        LDR      R1,[R0, #+4]
        BFI      R1,R4,#+0,#+9
        STR      R1,[R0, #+4]
//  331 		while(!USART3->__B.SR.TXE);
??USART3PutChar_0:
        LDR      R1,[R0, #+0]
        LSLS     R1,R1,#+24
        BPL.N    ??USART3PutChar_0
//  332 	#ifdef OS_INCLUDED
//  333 		OSSemPost(pUSART3.sem);
        LDR      R0,[R5, #+48]
        BL       OSSemPost
...
//  337 
        ...
        CFI Function USART3Printf
        THUMB
//  338 unsigned long int USART3Printf( const char *format, ...)
//  339 {
USART3Printf:
        PUSH     {R1-R3}
        CFI CFA R13+12
...
??USART3Printf_1:
        ...
        ITT      EQ 
        MOVEQ    R0,#+13
        BLEQ     USART3PutToBuffer
//  352 		USART3PutToBuffer(buf[i]);
        LDRB     R0,[R5], #+1
        BL       USART3PutToBuffer
??USART3Printf_0:
        LDRB     R0,[R5, #+0]
        CMP      R0,#+0
        BNE.N    ??USART3Printf_1
//  353 	}
//  354 	while(!USART3TxCheckByte())
??USART3Printf_2:
        BL       USART3TxCheckByte
        CBNZ.N   R0,??USART3Printf_3
//  355 	{
...
//  364 
        ...
        CFI Function USART3PutStr
        THUMB
//  365 void USART3PutStr(unsigned char *Str, unsigned short int Length, int iEn)
//  366 {
USART3PutStr:
        PUSH     {R3-R7,LR}
        CFI R14 Frame(CFA, -4)
...
//  372 	INT8U err;
//  373 	OSSemPend(pUSART3.sem, 0, &err);
        LDR.N    R4,??DataTable9_4
        ADD      R2,SP,#+0
        MOVS     R1,#+0
        LDR      R0,[R4, #+48]
...
//  377 	for(i = 0; i < Length; i++)
        LDRH     R0,[R4, #+6]
        CBZ.N    R6,??USART3PutStr_0
        LDR.N    R1,??DataTable9_7
//  378 	{
//  379 		Tx3Buff[Tx3WrCnt++] = Str[i];
??USART3PutStr_1:
        LDRB     R2,[R5, #+0]
        STRB     R2,[R0, R1]
        ADDS     R0,R0,#+1
//  380 		if(Tx3WrCnt >= Tx3BuffLen) Tx3WrCnt = 0;
        UXTH     R0,R0
        CMP      R0,#+2048
        IT       CS 
        MOVCS    R0,#+0
//  381 	}
        ADDS     R5,R5,#+1
        SUBS     R6,R6,#+1
        BNE.N    ??USART3PutStr_1
??USART3PutStr_0:
        STRH     R0,[R4, #+6]
//  382 
//  383 	if(iEn)
        CBZ.N    R7,??USART3PutStr_2
//  384 	{
//  385 		USART3->__B.CR1.TXEIE = ENABLE;
        LDR.N    R0,??DataTable9_8  ;; 0x4000480c
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x80
        STR      R1,[R0, #+0]
...
//  391 
        ...
        CFI Function USART3RxGetByte
        THUMB
//  392 signed short int USART3RxGetByte(void)
//  393 {
//  394 	s16 RetVal = 0;
//  395 
//  396 #ifndef APPL_SRC
//  397 	while(Rx3RdCnt == Rx3WrCnt);
//  398 #else
//  399 	if(Rx3RdCnt == Rx3WrCnt) return -1;
USART3RxGetByte:
        LDR.N    R1,??DataTable9_4
        LDRH     R2,[R1, #+0]
        LDRH     R0,[R1, #+2]
        CMP      R2,R0
        BNE.N    ??USART3RxGetByte_0
        MOV      R0,#-1
        BX       LR
//  400 #endif
//  401 
//  402 	RetVal = Rx3Buff[Rx3RdCnt%Rx3BuffLen];
??USART3RxGetByte_0:
        LSLS     R0,R2,#+21
        LSRS     R0,R0,#+21
        LDR.N    R3,??DataTable9_6
        LDRB     R0,[R0, R3]
//  403 	if(++Rx3RdCnt >= Rx3BuffLen) Rx3RdCnt = 0;
        ADDS     R2,R2,#+1
        STRH     R2,[R1, #+0]
        UXTH     R2,R2
        CMP      R2,#+2048
        BCC.N    ??USART3RxGetByte_1
        MOVS     R2,#+0
        STRH     R2,[R1, #+0]
//  404 
...
//  407 
        ...
        CFI Function USART3CheckByte
        THUMB
//  408 unsigned char USART3CheckByte(unsigned short int ByteCnt, unsigned short int *Recv)
//  409 {
USART3CheckByte:
        PUSH     {R4,R5}
        CFI R5 Frame(CFA, -4)
...
//  417 	if(i == j) RetVal = FALSE;
        CMP      R4,R3
        BEQ.N    ??USART3CheckByte_0
//  418 	else if(i < j)
        ADDS     R0,R0,R4
        CMP      R4,R3
        BCS.N    ??USART3CheckByte_1
//  419 	{
//  420 		*Recv = j - i;
        SUBS     R4,R3,R4
        STRH     R4,[R1, #+0]
...
//  422 		if(i > j) RetVal = FALSE;
        CMP      R3,R0
        BCS.N    ??USART3CheckByte_2
        B.N      ??USART3CheckByte_0
//  423 	}
//  424 	else if(i > j)
//  425 	{
//  426 		*Recv = (Rx3BuffLen +j) - i;
??USART3CheckByte_1:
        ADD      R5,R3,#+2048
        SUBS     R4,R5,R4
        STRH     R4,[R1, #+0]
...
//  433 
        ...
        CFI Function USART3BuffClear
        THUMB
//  434 void USART3BuffClear(void)
//  435 {
//  436 	Rx3RdCnt = 0;
USART3BuffClear:
        LDR.N    R0,??DataTable9_4
...
//  441 
        ...
        CFI Function USART3TxClear
        THUMB
//  442 void USART3TxClear(void)
//  443 {
//  444 	Tx3RdCnt = 0;
USART3TxClear:
        LDR.N    R0,??DataTable9_4
...
//  453 
        ...
        CFI Function USART3TxCheckByte
        THUMB
//  454 signed short int USART3TxCheckByte(void)
//  455 {
//  456 	if(Tx3RdCnt == Tx3WrCnt) return TRUE;
USART3TxCheckByte:
        LDR.N    R0,??DataTable9_4
        LDRH     R1,[R0, #+4]
        LDRH     R0,[R0, #+6]
        CMP      R1,R0
        BNE.N    ??USART3TxCheckByte_0
        MOVS     R0,#+1
        BX       LR
