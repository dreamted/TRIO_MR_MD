...
////////////////////////////////////////////////////////////////////////////////
	...
	#define _USR_DEV_EXL
#else
	#define _USR_DEV_EXL	extern
#endif

#include "stm32f2xx_1212.h"

#define BOOTMODE	0x0C


#define NOMODE		0x5A5A  // boot default set
#define APDNMODE	0x5AA5  // Application download set
#define APPMODE		0xA55A  // download rst
#define APDNSRAM	0x188A
...
const unsigned short int Crc_tbl[256] =
...
const uint16 CRC_16_Table[ CRC_TAB_SIZE ] = {
...
uint16 makeFCS(uint8 *pBuffer,uint16 pSize,uint16 *pCalcFCS)
{
	uint16 index;
	uint8 c_byte;
...
int main(int argc, char **argv)
{
	...
	char pBuffer[256];
	uint16 pSize = 256;
	calc_fcs = makeFCS(pBuffer,pSize,&calc_fcs);
	calc_fcs ^= 0xffff;
}
...
// Global Variable Declaration
//////////////////////////////
extern INT16S WriteEEprom(INT8U DevID, INT16U ADDR, INT8U Data, INT8U Path);
extern INT8U ReadEEprom(INT8U DevID, INT16U ADDR, INT8U Path);
