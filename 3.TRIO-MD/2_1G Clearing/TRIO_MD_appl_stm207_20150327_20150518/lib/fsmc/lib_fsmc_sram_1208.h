...
#define	nCS15			*((volatile unsigned char *)(EXPIOptr))




//#define FLASH_SIZE				(*(INT16U *)0x1FFFF7E0)
//#define FLASH_SIZE				(128-32)



#define __pAPBK_SRAMAddr        ((u32)&nCS15 + ((512-(256-32))*1024L))  
//#define __pAPBK_SRAMAddr		((u32)&nCS15 + ((512-(FLASH_SIZE-28))*1024L))
//#define __pAPBK_SRAMAddr		((u32)&nCS4 + 0x8000)
