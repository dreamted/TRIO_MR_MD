...
/** @defgroup USART Line Control user definition
  * 
  * | 7 | 6 | 5 | 4     | 3 | 2 | 1 | 0 |
  *		        | DATA  | STOP  | PARITY|
  * @{
...
#define _DATA8BIT	  	0 << 4
#define _DATA9BIT	  	1 << 4
...
/** 
  * @brief  USART function Structure definition  
  */ 

typedef struct {
	void (*init)(unsigned long int nBps, unsigned long int nLCR);
