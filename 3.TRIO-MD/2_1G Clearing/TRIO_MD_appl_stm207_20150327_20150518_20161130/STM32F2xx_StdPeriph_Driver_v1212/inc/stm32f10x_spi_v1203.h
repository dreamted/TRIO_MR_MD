...
typedef struct
{
	union {
		...
		struct {
			...
			vu16 CRCEN		:1;
			vu16 BIDIOE		:1;
			vu16 BIDMODE	:1;		// rw, bidiretional data mode enable
									//	   0: 2_line
		} Bit;
	} CR1;
	u16  RESERVED0;
...
#define __SPI_DIV2						0x00
#define __SPI_DIV4						0x01
#define __SPI_DIV8						0x02
#define __SPI_DIV16						0x03
#define __SPI_DIV32						0x04
#define __SPI_DIV64        				0x05
#define __SPI_DIV128					0x06
#define __SPI_DIV256					0x07
