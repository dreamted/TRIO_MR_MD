...
///////////////////////////////////////////////////////
		...
		#ifdef _2_1G_Clearing

//		Sts->Band_Select_WCDMALTE_21[0] = 0x00;
//		DTU_WriteData(CS0SEL, DTU_BW_SEL_B2, Sts->Band_Select_WCDMALTE_21[0]);
			Sts->FwdOutUpperLmt_LTE_21[0] = FwdHighLmt_Clearing;
			Sts->FwdOutUpperLmt_LTE_21[1] = 0;	   
			
			Sts->FwdOutUpperLmt_3G[0] = FwdHighLmt_Clearing;
...
#ifdef _2_1G_Clearing
	Sts->Band_Select_CDMALTE[0] = 0x00;
	Sts->Band_Select_LTE_A[0] = 0x00;
	Sts->Band_Select_WCDMALTE_21[0] = 0x00;
	tDnrSts->FilterStart = Enable;
	IsItFilter = SET;
#endif
