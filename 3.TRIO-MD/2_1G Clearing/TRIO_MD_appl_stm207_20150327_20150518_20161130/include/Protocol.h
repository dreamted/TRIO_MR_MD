...
#define GainMAX				10		//31.5dB


#define GainMIN				-5*2		//31.5dB
...
#define ULALCATTENMIN			-8*2
#define ULALCATTENMAX			 5*2
...
#define AGC25_ATTENMAX			25*2
#define AGC15_ATTENMAX			15*2
#define AGC10_ATTENMAX			10*2

#define RVSAGC15_ATTENMAX		15*2
...
#define RVSALC18_ATTENMAX	19*2		//31.5dB
#define RVSALC23_ATTENMAX	24*2		//31.5dB
#define RVSALC24_ATTENMAX	25*2		//31.5dB


/////////////////////////////////////////////////
#define MAXGain_800M			81*2
#define MAXGain_1800M			86*2
#define MAXGain_2100M			87*2

#define ISOGain_800M			51*2
#define ISOGain_1800M			56*2
#define ISOGain_2100M			57*2



#define MINGain_800M			31*2
#define MINGain_1800M			41*2
#define MINGain_2100M			47*2

#define RvsMINGain_800M			21*2
#define RvsMINGain_1800M		28*2
#define RvsMINGain_2100M		28*2


#define AGCATTMAX_800M			50*2
#define AGCATTMAX_1800M			45*2
#define AGCATTMAX_2100M			40*2


#define RVSALCATTMAX_800M		43*2
#define RVSALCATTMAX_1800M		48*2
#define RVSALCATTMAX_2100M		49*2


#define DTUBGain_800M			45*2
#define DTUBGain_1800M			50*2
#define DTUBGain_2100M			51*2




#define DTUAGain_800M			37*2
#define DTUAGain_1800M			38*2
#define DTUAGain_2100M			40*2

#if 0
#define DTUBGain_800M			44*2
#define DTUBGain_1800M			48*2
#define DTUBGain_2100M			47*2
#endif
//#define DTUULBGain				45*2
#define DTUULAGain				36*2


#define DTUBInGain_800M			34*2
#define DTUBInGain_1800M		38*2
#define DTUBInGain_2100M		37*2


#define DTUULBInGain_800M		35*2
#define DTUULBInGain_1800M		40*2
#define DTUULBInGain_2100M		41*2
...
//#define FwdMinGain_LTE_A		47*2
//#define FwdMinGain_3G			41*2
...
//#define DefaultGain_3G			47*2
//#define DefaultGain_LTE_A		41*2
//#define DefaultGain_LTE_21		41*2

#define DefaultGainBalance		5


//#define AGCMAX_2G				50*2
//#define tRvsALCMAX_2G			43*2

//#define AGCMAX_LTE				50*2
//#define tRvsALCMAX_LTE			43*2

//#define AGCMAX_3G				40*2
//#define tRvsALCMAX_3G			49*2

//#define AGCMAX_LTE_A1			45*2
//#define tRvsALCMAX_LTE_A1		48*2
...
#if 1
#define OtherFwdOverInLmt_CDMALTE		0*2 	///// 0dBm에서 동작 
#define OtherFwdOverInLmt_LTE_A			0*2 	///// 0dBm에서 동작 
#define OtherFwdOverInLmt_WCDMALTE_25	0*2 	///// 0dBm에서 동작 
#endif
...
#define FwdOverInAlmLmt_LTE_21		-24
#define FwdOverInSDAlmLmt_LTE_21	-24

#define FwdOverInAlmLmt_3G			-21
#define FwdOverInSDAlmLmt_3G		-21
...
#define FwdHighLmt_3G			23

#define FwdHighLmt_LTE_21		20
...
#define RvsHighLmt_LTE_21		21
#endif

#define FwdHighLmt_Clearing		20


#if 0
#define RvsHighLmt_2G			-17
#define RvsHighLmt_LTE			-17
#define RvsHighLmt_LTE_A		-17
#define RvsHighLmt_3G			-17
#define RvsHighLmt_LTE_21		-17
#endif
...
#define	FTPDownloadCMD				0x50
#define	FTPDownLoadDataConfirm		0x52
